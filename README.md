...
## Ευκολίες καταχώρησης ##

Το πρόγραμμα καταχώρησης στοιχείων παρουσιολογίων παρέχει κάποιες
ευκολίες προκειμένου να διευκολυνθεί κατά το δυνατόν ο συντάκτης κατά
την καταχώρηση των στοιχείων.

### Μαζικές ενέργειες ###
Ο συντάκτης μπορεί να επιλέξει υπαλλήλους και να εκτελέσει
μαζικές εργασίες σε όλους τους υπαλλήλους που έχει επιλέξει, η στους
υπαλλήλους που δεν έχει επιλέξει. Οι μαζικές ενέργειες αφορούν στη
*διαγραφή υπαλλήλων*, στην *αλλαγή ωραρίου*, ή στην
*αυτόματη συμπλήρωση ώρας προσέλευσης ή αποχώρησης*.
Η επιλογή ή η αποεπιλογή ενός υπαλλήλου γίνεται με κλικ στον αύξοντα αριθμό
γραμμής που αφορά τον συγκεκριμένο υπάλληλο. Ο χρήστης μπορεί να επιλέξει
ή να αποεπιλέξει περισσότερους από έναν υπαλλήλους, αν κάνοντας κλικ στον
αύξοντα αριθμό έχει ταυτόχρονα πατημένο το πλήκτρο Shift. Οι επιλεγμένοι
υπάλληλοι εμφανίζονται με κόκκινο χρώμα στο κελί τους αύξοντα αριθμού.

### Συντομογραφίες σχολίων ###

Στο πεδίο καταγραφής σχολίων/παρατηρήσεων ο χρήστης μπορεί να
πληκτρολογήσει ένα παπάκι (@) συνοδευόμενο από μια ημερομηνία, πράγμα
το οποίο θα μεταγραφεί αυτόματα σε σχόλιο της μορφής "Εργάστηκε…",
ή "Θα εργαστεί…" και αφορά σε ρεπό ανάπαυσης όπου στο σχόλιο είναι καλό
να αναγράφεται η ημερομηνία κατά την οποία εργάστηκε ή θα εργαστεί ο εν
λόγω υπάλληλος. Αν π.χ. το δελτίο αφορά στις 12 Μαρτίου 2025, τότε
ένα σχόλιο της μορφής "@8-3-2025" θα μεταγραφεί ως "Εργάστηκε 08-03-2025",
ενώ ένα σχόλιο της μορφής "@15-3-2025" θα μεταγραφεί ως "Θα εργαστεί
15-03-025".

Επίσης, υπάρχουν συντομογραφίες συνηθισμένων σχολίων, π.χ. "ΠΤ" για
"ΠΡΟΣΩΡΙΝΗ ΤΟΠΟΘΕΤΗΣΗ" κλπ.

## Ιδιαιτερότητες ##
Κατά τη διαδικασία της κλωνοποίησης διαγράφονται τα σχόλια εκτός εκείνων των
σχολίων που αφορούν σε άδειες. Ωστόσο, κάποια σχόλια είναι χρήσιμο να
επαναλαμβάνονται. Τέτοια σχόλια είναι π.χ. "ΠΡΟΣΩΡΙΝΗ ΤΟΠΟΘΕΤΗΣΗ" κλπ.
