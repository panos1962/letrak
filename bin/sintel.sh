...
#
# Με την option -d μπορούμε να επιλέξουμε μεγαλύτερο ή μικρότερο διάστημα
# (σε ημέρες), ενώ με την option -m καθορίζουμε κάποιο email στο οποίο θα
# αποσταλούν τα αποτελέσματα.
# @DESCRIPTION END
#
# @HISTORY BEGIN
# Updated: 2024-12-16
