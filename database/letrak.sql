...
-- στοιχείων από το ΟΠΣΟΥ, ενώ τα είδη αδειών που θα απομείνουν μπορούμε να
-- τα ταξινομήσουμε με τρόπο που να διευκολύνουν την αναζήτηση, δηλαδή πρώτα
-- τα συχνότερα χρησιμοποιούμενα είδη και τελευταία τα είδη εκείνα που σπάνια
-- χρησιμοποιούνται.
