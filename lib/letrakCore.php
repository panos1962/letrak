...
class Orario {
	...
	// τα όρια ελέγχου καταγραφών με βάση την παράμετρο ανοχής ελέγχου
	// καταγραφής (LETRAK_ORARIO_ANOXI_MAX) που είναι της τάξης μιας
	// ή μιάμιση ώρας πριν και μετά την ώρα προσέλευσης που ορίζει το
	// ανά χείρας ωράριο. Πιο συγκεκριμένα, αν κάποιος εργαζόμενος έχει
	// ωράριο "08:00-16:00", η εν λόγω μέθοδος για την ημερομηνία
	// 2020-05-13 θα επιστρέψει "2020-05-13 08:00:00" και θα θέσει
	// το διάστημα ελέγχου καταγραφών από "2020-05-13 06:30:00" έως
	// "2020-05-13 09:30:00", εφόσον η παράμετρος ανοχής ελέγχου
	// καταγραφής είναι μιάμιση ώρα.
