...
letrak.deltio.prototype.closedSet = function(x) {
	if (x)
...
letrak.deltio.prototype.closedGet = function() {
	return this.closed;
};

letrak.deltio.prototype.isClosed = function() {
	return this.closed;
};
...
letrak.parousia.prototype.excuseAdiaGet = function() {
	...
	if (letrak.adidos.hasOwnProperty(s))
	s = letrak.adidos[s];
