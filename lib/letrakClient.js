...
// Η function "xristisSetup" καλείται συνήθως από την "toolbarSetup" κα σκοπό
// έχει την εμφάνιση στη δεξιά πλευρά του toolbar των tabs που αφορούν στην
// επώνυμη ή ανώνυμη χρήση της εφαρμογής.

letrak.xristisSetup = () => {
	let ipalilos = letrak.isXristis();

	if (ipalilos)
	letrak.xristisSetupYes(ipalilos);

	else
	letrak.xristisSetupNo();
