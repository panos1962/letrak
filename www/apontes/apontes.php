...
//
// @FILE BEGIN
// www/apontes/apontes.php —— Ανίχνευση και αποστολή απόντων ημέρας
// παρουσιολογίου.
// @FILE END
//
// @DESCRIPTION BEGIN
...
// οι απόντες αφορούν μόνο στην προσέλευση, επομένως είναι πιο ασφαλές να
// εφαρμόζεται η παρούσα διαδικασία σε παρουσιολόγιο αποχώρησης.
// @DESCRIPTION END
//
// @HISTORY BEGIN
// Updated: 2025-07-11
...
class Apontes {
	...
	// Ακολουθούν τα στοιχεία του συντάκτη των παρουσιολογίων.
	...
	private static function parousia_fetch($deltio) {
		...
		while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
			...
			// Αν υπάρχει παρατήρηση, τότε αυτή μάλλον αφορά σε
	...
	// Παίρνουμε τα στοιχεία του συντάκτη των παρουσιολογίων με κύριο
	// σκοπό να εμφανίσουμε το τηλέφωνο επικοινωνίας.

	public static function sintaktis_fetch() {
		// Εντοπίζουμε το κατάλληλο παρουσιολόγιο από το οποίο θα
		// εξαγάγουμε τον συντάκτη. Προτιμούμε το παρουσιολόγιο
		// αποχώρησης.
		...
		// Εντοπίζουμε τον συντάκτη ως πρώτο υπογράφοντα από το
		// παρουσιολόγιο που έχει επιλεγεί.
		...
		// Εντοπίζουμε τον συντάκτη από τον πίνακα προσβάσεων όπου
		// έχουμε καταχωρήσει το τηλέφωνο επικοινωνίας.
		...
		// Τέλος, εντοπίζουμε τον υπάλληλο από τον πίνακα υπαλλήλων
		// προσωπικού για να πάρουμε το ονοματεπώνυμο του συντάκτη.
