...
// ασυμφωνίες. Αν το δελτίο που δόθηκε είναι δελτίο προσέλευσης και
// δεν έχει ετοιμαστεί ακόμη το αντίστοιχο δελτίο αποχώρησης, τότε το
// πρόγραμμα διαχειρίζεται μόνο το δελτίο προσέλευσης.
// @DESCRIPTION END
//
// @HISTORY BEGIN
// Updated: 2024-11-23
