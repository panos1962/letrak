...
// "pro" για το αντίστοιχο προηγούμενο. Ωστόσο, η παράμετρος "pro" δύναται
// να παραλειφθεί και σ' αυτή την περίπτωση το πρόγραμμα θα επιχειρήσει να
// εντοπίσει το προηγούμενο παρουσιολόγιο. Αν παραλειφθεί και η παράμετρος
// "tre", τότε το πρόγραμμα θα επιχειρήσει να προσδιορίσει το τρέχον δελτίο
