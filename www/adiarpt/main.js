...
//
// @DESCRIPTION BEGIN
// Το παρόν πρόγραμμα οδηγεί τη σελίδα εκτύπωσης αδειών και απόντων (ΣΑΑ).
// Η ΣΑΑ εκκινεί από τη βασικής σελίδα διαχείρισης δελτίων, όπου ο χρήστης
// επιλέγει (μέσω φίλτρων) μια ομάδα συναφν δελτίων, π.χ. όλα τη δελτία που
// αφορούν στην Διεύθυνση Διαχείρισης Ανθρώπινων Πόρων για τον Ιούνιο του 2021.
// Αφού επιλεγούν τα παρουσιολόγια, ο χρήστης επιλέγει "Εκτύπωση Αδειών" από
// το tab "Επεξεργασία", οπότε εμφανίζεται η ΣΑΑ σε νέα καρτέλα του browser
// με πλέγμα στο οποίο κάθε οριζόντια γραμμή αφορά σε κάποιον υπάλληλο, ενώ
// οι κάθετες γραμμές αφορούν σε κάθε μια ημέρα για το διάστημα επιλογής.
// Συνήθως επιλέγουμε δελτία για χρονικό διάστημα ενός μηνός, οπότε η ΣΑΑ
// είναι διαχείριση και εκτυπώσιμη στην οριζόντια διάσταση.
// @DESCRIPTION END
//
// @HISTORY BEGIN
// Updated: 2025-01-22
...
adiarpt.adiaEconomyMap = {
	...
	'ΑΝΕΥ ΑΠΟΔΟΧΩΝ': 'ΑΑ',
	'ΕΚΤΟΣ ΕΔΡΑΣ': 'ΕΕ',
	'ΕΣΩΤΕΡΙΚΗ ΔΙΑΘΕΣΗ': 'ΕΔ',
	'ΑΠΟΣΠΑΣΗ': 'ΑΠ',
	'ΔΙΑΘΕΣΙΜΟΤΗΤΑ': 'ΔΘ',
	'ΑΡΓΙΑ': 'ΑΡ',
	'ΛΥΣΗ ΣΧ. ΕΡΓΑΣΙΑΣ': 'ΑΛ',
	'ΜΕΤΑΚΙΝΗΣΗ': 'ΜΚ',
	'ΑΔΙΚΑΙΟΛΟΓΗΤΗ ΑΠΟΥΣΙΑ': 'ΑΔ'
};
...
// Ακολουθεί βασική function ελέγχου δεδομένων. Αν διαπιστωθεί οποιοδήποτε
// βασικό σφάλμα, τότε εκτυπώνεται σχετικό μήνυμα λάθους και η σελίδα διακόπτει
// τη λειτουργία της.
