...
//
// katastasi	Επιλέγονται παρουσιολόγια κλειστά, εκκρεμή ή όλα, ανάλογα με
//		με το αν η τιμή της παραμέτρου είναι "ΚΛΕΙΣΤΑ", "ΑΝΟΙΚΤΑ" ή
//		ή κενό αντίστοιχα.
//
...
// Το κριτήριο κατάστασης παίρνει τιμές "ΚΛΕΙΣΤΑ", "ΑΝΟΙΚΤΑ", ή κενό.
