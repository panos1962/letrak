...
// έχει τη μαζική αλλαγή ωραρίου σε υπαλλήλους. Ως παραμέτρους δέχεται τον
// κωδικό δελτίου και ένα array με τους κωδικούς των υπαλλήλων στους οποίους
// θα εφαρμοστεί η αλλαγή.
// @DESCRIPTION END
//
// @HISTORY BEGIN
// Updated: 2025-04-24
