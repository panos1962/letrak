...
// Η function "diagrafiEpilegmenon" καλείται από την επιλογή "Διαγραφή
// επιλεγμένων" του βασικού μενού επεξεργασίας δελτίου και δέχεται ως
// παράμετρο το click event της επιλογής.
...
// Η function "orarioEpilegmenon" καλείται από την επιλογή "Ωράριο
// επιλεγμένων" του βασικού μενού επεξεργασίας δελτίου και δέχεται
// ως παράμετρο το click event της επιλογής. Με τη συγκεκριμένη επιλογή
// εμφανίζεται φόρμα καθορισμού ωραρίου και τίθεται το συγκεκριμένο
// ωράριο στους επιλεγμένους υπαλλήλους.
...
// Η function "iperoriaEpilegmenon" καλείται από την επιλογή "Υπερωρίες
// επιλεγμένων" του βασικού μενού επεξεργασίας δελτίου και δέχεται ως
// παράμετρο το click event της επιλογής. Με τη συγκεκριμένη επιλογή
// εμφανίζεται φόρμα καθορισμού ωρών υπερωρίας και συμπληρώνεται η ώρα
// προσέλευσης/αποχώρησης με τιμές τέτοιες που να δείχνουν ότι οι
// επιλεγμένοι υπάλληλοι εργάστηκαν επιπλέον ώρες.
...
// επιλεγμένων υπαλλήλων. Αν υπάρχει κωδικός υπαλλήλου ως παράμετρος,
// τότε αυτός ο υπάλληλος εξαιρείται από τους επιλεγμένους.
...
prosopa.epilogiList = function(exereteos) {
	...
	if (exereteos) {
		exereteos = parseInt(exereteos);

		if (!isNaN(exereteos))
		delete plist[exereteos];
	}
